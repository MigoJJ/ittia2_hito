...
public class DBM_process {
	public static void main(String bchoice) throws Exception {
		...
		if (bchoice== "HTML5") {
			Open_HTMLFormat_files.main("firefox /home/migowj/ittia_chart/GDS_support_html");
			}
		else if (bchoice== "ROS") {
			ExecuteROS_jar.main(null);
			}
		else if (bchoice== "consult") {
			Open_HTMLFormat_files.main("firefox /home/migowj/ittia_chart/GDS_support_html/Consultation_sheet");
		}
